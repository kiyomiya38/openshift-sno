...
aws route53 list-resource-record-sets --hosted-zone-id "$hosted_zone_id" --query "ResourceRecordSets[?contains(Name, '${CLUSTER_NAME}.${BASE_DOMAIN}')].[Name,Type]" --output table
