...
plan_kind="$(phase6_prerequisite_plan_kind "$changes_json")" \
  || phase6_error 'Saved Plan does not exactly match an allowed Phase 6 prerequisite pass. Do not apply.'
[[ "$plan_kind" != converged ]] || phase6_error 'Saved Plan has no managed changes. Run scripts/16 again.'
